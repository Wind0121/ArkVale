...
from transformers.models.mistral.modeling_mistral import MistralMLP, MistralAttention
...
class ArkValeMistralAttention(MistralAttention):
...
class MistralDecoderLayer(nn.Module):
    def __init__(self, config: MistralConfig, layer_idx: int):
        ...
        self.self_attn = ArkValeMistralAttention(config=config, layer_idx=layer_idx)
