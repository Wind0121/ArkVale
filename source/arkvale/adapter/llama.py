...
class ArkValeLlamaAttention(LlamaAttention):
        ...
        if do_send_pf:
            ...
            if rids[..., 0].any():
                ...
                with torch.cuda.stream(
                    state.prefetch_streams[cur_id % (n_pf_layers + 1)]
                ):
...
class LlamaDecoderLayer(nn.Module):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.self_attn = ArkValeLlamaAttention(config=config, layer_idx=layer_idx)
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.infer_state: InferState = None
    ...
    def forward(
        ...
        self.infer_state.begin_forward(batch_size, seq_length)
        ...
        self.infer_state.end_forward(batch_size, seq_length)
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def arkvale_reset(
        ...
        **kwargs,
        ...
        self.model.infer_state = InferState(
    ...
    def forward(
        ...
        if self.config.pretraining_tp > 1:
            ...
            logits = self.lm_head(hidden_states[:, -1:, :])  # CRZ avoid OOM
        logits = logits.float()
